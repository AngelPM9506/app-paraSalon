...
class AdminController{
    public static function index(Router $router){
        ...
        $consulta = "SELECT citas.id, citas.hora, CONCAT(usuarios.nombre,' ',usuarios.apellido) as cliente, CONCAT(usuarios.correo,' | ',usuarios.telefono) as datos, servicios.nombre as servicio, servicios.precio ";
        $consulta .= "FROM citas ";
